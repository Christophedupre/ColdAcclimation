...
ax = gca; ax.YTick = [0 0.2 1] ;ax.XLabel.String = '\alpha'; ax.YLabel.String = 'Health'; ax.XLim(1) = 0; ax.YLim(1) = 0;
...
YData = Cst10C13D30Reps'; YData = YData + (rand(30,29)-0.5)./40;
s = scatter(XData,YData,'MarkerFaceColor',...
        cmaplines(1,:), 'MarkerEdgeColor','none','SizeData',2);
plot(XData,YData,'Color',[cmaplines(1,:) 0.5]);
