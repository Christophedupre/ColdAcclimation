...
GradientDurationS = GradientDurationS + (rand(size(GradientDurationS,1),size(GradientDurationS,2))-0.5).*1;
Data = Pilot.dataGradientAll + (rand(size(Pilot.dataGradientAll,1),size(Pilot.dataGradientAll,2))-0.5)./20;
