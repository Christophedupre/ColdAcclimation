...
% h1.Normalization = 'probabidlity'; h2.Normalization = 'probability';
% h1.EdgeColor = 'none'; h1.FaceAlpha = 0.5; h1.BinEdges = linspace(0,1,14);
% h2.EdgeColor = 'none'; h2.FaceAlpha = 0.5; h2.BinEdges = linspace(0,1,14); h2.FaceColor = cmaplines(5,:);
% ax = gca; ax.Box = 'off'; ax.LineWidth = 1; ax.FontSize = 8; ax.XLim = [0 1]; ax.YTick = [0:0.7:0.7]; ax.YLim = [0 0.7];
...
% Model1DataTR.HealthFull = DiscretizeModelData(Model1DataTR.HealthFull);
% Model1DataTR.HealthTruncated = DiscretizeModelData(Model1DataTR.HealthTruncated);
...
% Model2DataTR.HealthFull = DiscretizeModelData(Model2DataTR.HealthFull);
% Model2DataTR.HealthTruncated = DiscretizeModelData(Model2DataTR.HealthTruncated);
...
% Model without noise
for i = 1:imax;
    pd = i-1; %Pulse (i.e. training) duration (days)
%     cvar = Model2Data.csol.c.*(1+(rand(3,1)-0.5)/4);% Add variability for acclimation, injury and regeneration time constants
    ...
    temperature = [temperature1; temperature2];
    % sol = ode23(@(t,y) Acclimfun2(t,y,cvar,temperature), Model2Data.tspan, Model2Data.y0);
    sol = ode23(@(t,y) Acclimfun(t,y,cvar,temperature), Model2Data.tspan, Model2Data.y0);
    solptstemp = deval(Model2Data.tspan,sol);    
...
% Model1Pulses1_1Data.HealthFull = DiscretizeModelData(Model1Pulses1_1Data.HealthFull);
% Model1Pulses1_1Data.HealthTruncated = DiscretizeModelData(Model1Pulses1_1Data.HealthTruncated);
...
% Model2Pulses1_1Data.HealthFull = DiscretizeModelData(Model2Pulses1_1Data.HealthFull);
% Model2Pulses1_1Data.HealthTruncated = DiscretizeModelData(Model2Pulses1_1Data.HealthTruncated);
...
for i = 1:28    
    Dur = i-1;
    temperature2 = [linspace(22,22,Dur*f)]./22; %Duration = 13 days, training temperature = 10C
    % if i == 18
    ...
    % sol = ode23(@(t,y) Acclimfun2(t,y,cvar,temperature), tspan, y0);
...
% health1 = DiscretizeModelData(health1);
% health2 = DiscretizeModelData(health2);
...
ax = gca; ax.XLabel.String = 'Time (Days)'; ax.YLabel.String = 'T (C)';
ax.YLim = [0 25];
ax.Title.String = 'Using 2 different c1 for Acc and Deacc';
...
h3.ColorbarVisible = 'off'; h3.XLabel = 'Testing Time (Days)'; h3.YLabel = 'Training Duration (Day)';
h3.FontSize = 8;
h3.Title = 'Health model with 2 different c1';
h3.XDisplayLabels(:) = {''}; h3.YDisplayLabels(:) = {''};
h3.XDisplayLabels([1 5 10 15 20 25]) = {'0', '5', '10', '15', '20', '25'};
h3.YDisplayLabels([1 6 11 15]) = {'0', '5', '10', '14'};
h3.Colormap = cmaphisto;
...
%%% DEACCLIMATION WITH 2 DIFFERENT C1 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Deacclimation cartoon
nexttile(); hold on;
cmapturbo = colormap('turbo');
cmaplines = colormap('lines');
...
% Model13CData1.HealthFull = DiscretizeModelData(Model13CData1.HealthFull);
% Model13CData1.HealthTruncated = DiscretizeModelData(Model13CData1.HealthTruncated);
% Model13CData2.HealthFull = DiscretizeModelData(Model13CData2.HealthFull);
% Model13CData2.HealthTruncated = DiscretizeModelData(Model13CData2.HealthTruncated);
