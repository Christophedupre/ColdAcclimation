...
csol.c = [0.37; 0.43; 0.13]; %Intermediate c1
...
% Model1Data.HealthFull = DiscretizeModelData(Model1Data.HealthFull);
% Model1Data.HealthTruncated = DiscretizeModelData(Model1Data.HealthTruncated);
% Model2Data.HealthFull = DiscretizeModelData(Model2Data.HealthFull);
% Model2Data.HealthTruncated = DiscretizeModelData(Model2Data.HealthTruncated);

Model1Data.name = 'ODE without noise';
Model2Data.name = 'ODE with noise';
end